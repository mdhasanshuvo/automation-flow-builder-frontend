...
import { getAllAutomations, deleteAutomation, Automation } from '@/lib/automationService';
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Automation Flow Builder</h1>
              <p className="mt-1 text-sm text-gray-500">Create and manage your email automation workflows</p>
            </div>
            <Link
              href="/editor/new"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="mt-1 text-sm text-gray-500">Get started by creating a new automation.</p>
            <div className="mt-6">
              <Link
                href="/editor/new"
      ...
      {/* Test Run Dialog */}
      {showTestDialog && selectedAutomation && (
        <TestRunDialog
